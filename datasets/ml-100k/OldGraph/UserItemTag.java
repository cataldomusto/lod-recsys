...
public class UserItemTag extends RecGraph {
    ...
    public UserItemTag(String trainingFileName, String testFileName,
                       List<MovieMapping> mappedItems, Map<String, List<String>> tagmeConcepts) throws IOException {
        generateGraph(new RequestStruct(trainingFileName, testFileName, mappedItems, tagmeConcepts));
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int numSplit = 1; numSplit <= 5; numSplit++) {
            ...
            UserItemTag graph = new UserItemTag(testPath + File.separator + "u" + numSplit + ".base", testPath + File.separator + "u" + numSplit + ".test",
                    mappingList, Utils.loadTAGmeConceptsForItems(tagmeDir));
