...
import di.uniba.it.lodrecsys.graph.GraphFactory;
...
public class GraphRunner {
    private static Logger LOGGERGRAPHRUNNER = Logger.getLogger(di.uniba.it.lodrecsys.graph.GraphRunner.class.getName());

    public static void main(String[] args) throws IOException {

//        PropertiesManager propertiesManager =new PropertiesManager(LoadProperties.PROPERTYINDEXDIR);
//        propertiesManager.restart();
//        System.exit(2);
